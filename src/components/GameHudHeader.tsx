    ...
    <header className="w-full bg-gradient-to-b from-[#1a1a2e] to-[#0d0d1a] relative sticky top-0 z-50">
      ...
      <div className="absolute bottom-2 left-20 right-20">
        <div className="xp-bar-track">
          <div className="xp-bar-fill" style={{ width: '35%' }} />
        </div>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto h-[72px] px-5 flex items-center justify-between relative z-10">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="font-cinzel text-[22px] font-bold text-gold leading-none" style={{ textShadow: '0 0 10px #ffd70066, 0 2px 4px #00000088' }}>
              Stat Stackers
            </span>
            <span className="font-rajdhani text-[11px] font-semibold text-teal uppercase tracking-[3px] mt-0.5" style={{ textShadow: '0 0 8px #00ffcc66' }}>
